...
use pipeline::candidate::filter::GameFilter;
use pipeline::candidate::feature::FeatureBuilder;
use pipeline::candidate::score::Scorer;
use pipeline::candidate::select::Selector;
...
pub struct ExperimentConfig<F> {
    ...
    pub selector: Arc<dyn Selector<F> + Send + Sync>,
}
